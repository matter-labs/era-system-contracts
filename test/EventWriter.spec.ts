...
describe('EventWriter tests', function () {
    ...
    it.skip('zero topics', async () => {
        ...
        await expect(eventWriterTest.zeroTopics('0x'))
            .to.emit(eventWriterTest, 'ZeroTopics')
            .withArgs('0x')
    });
    ...
    it('two topics', async () => {
        await expect(eventWriterTest.twoTopics('0x1278378123784223232874782378478237848723784782378423747237848723', '0xabcd'))
    ...
    it('four topics', async () => {
        await expect(eventWriterTest.fourTopics('0x1234567890', 0, 22, '0x2828383489438934898934893894893895348915893489589348958349589348958934859348958934858394589348958934854385838954893489'))
            .to.emit(eventWriterTest, 'FourTopics')
            .withArgs('0x1234567890', 0, 22, '0x2828383489438934898934893894893895348915893489589348958349589348958934859348958934858394589348958934854385838954893489')
    });
});
