import {
    TEST_ACCOUNT_CODE_STORAGE_SYSTEM_CONTRACT_ADDRESS, TEST_BOOTLOADER_FORMAL_ADDRESS,
    ...
    TEST_L1_MESSENGER_SYSTEM_CONTRACT_ADDRESS, TEST_MSG_VALUE_SYSTEM_CONTRACT_ADDRESS,
    TEST_NONCE_HOLDER_SYSTEM_CONTRACT_ADDRESS
} from "./constants";
import {ethers} from "hardhat";
import {deployContractOnAddress, getWallets, loadArtifact} from "./utils";
import {MockContract__factory, MockContract} from "../../typechain-types";
...
export async function setResult(contractName: string, functionName: string, args: any[] | string | undefined, result: CallResult) {
